def solution(member_age, transportation):
  ...
  if len(member_age) >= 10:
     adult_expense = adult_expense * 9 // 10
     child_expense = child_expense * 8 // 10
...
# member_age, transportation이 다음과 같을때 return값을 구하시오
# [10, 20, 30], “Bus”
# solution 함수의 반환 값은 95000 입니다.
